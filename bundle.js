...
/***/ function(module, exports, __webpack_require__) {
	...
	var _kanbanBoard = __webpack_require__(163);

	var cardsList = [];

	(0, _reactDom.render)(React.createElement(_kanbanBoard.KanbanBoard, null), document.getElementById('root'));
	  ...
	  _createClass(KanbanBoard, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'app' },
	        _react2.default.createElement(_list.List, { id: 'todo', title: 'To Do', cards: this.props.cards.filter(function (card) {
	            return card.status === 'todo';
	          }) }),
	        _react2.default.createElement(_list.List, { id: 'in-progress', title: 'In Progress', cards: this.props.cards.filter(function (card) {
	            return card.status === 'in-progress';
	          }) }),
	        _react2.default.createElement(_list.List, { id: 'done', title: 'Done', cards: this.props.cards.filter(function (card) {
